...
const creationCards = [
  {
    ...
    icon: Camera,
    className: "bg-gradient-to-br from-moment/40 via-sky-soft/30 to-moment/10",
    iconClassName: "text-midnight/70",
    actionClassName: "border-moment/60 text-midnight/75 group-hover:border-midnight group-hover:text-midnight",
  },
  {
    href: "/create/guide",
    title: "Guide",
    ...
    icon: BookOpen,
    className: "bg-gradient-to-br from-guide/30 via-pink/15 to-guide/10",
    iconClassName: "text-guide/80",
    actionClassName: "border-guide/50 text-guide group-hover:border-guide group-hover:text-guide",
  },
  {
    href: "/create/list",
    title: "List",
    ...
    icon: ListChecks,
    className: "bg-gradient-to-br from-list/35 via-sand/30 to-list/10",
    iconClassName: "text-midnight/75",
    actionClassName: "border-list/60 text-midnight/75 group-hover:border-midnight group-hover:text-midnight",
  },
];
