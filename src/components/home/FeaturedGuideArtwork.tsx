...
export function FeaturedGuideArtwork({ guide, productIds, author, showCopy = true, className }: FeaturedGuideArtworkProps) {
  ...
  return (
    <div className={`relative aspect-[4/5] overflow-hidden bg-text ${className ?? ""}`}>
      ...
      {showCopy && <div className="absolute inset-x-0 top-0 z-10 p-4 text-white">
        <span className="inline-flex rounded-md bg-guide/90 px-2 py-1 text-[8px] font-bold uppercase tracking-[0.14em] text-midnight">Guide</span>
