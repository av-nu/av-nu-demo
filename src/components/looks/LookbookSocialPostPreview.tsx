...
export function LookbookSocialPostPreview({ title, description, products, layout, backgroundColor, backgroundImage, editorialDesign, media, layflatStyle, gridItemCount }: LookbookSocialPostPreviewProps) {
  return (
    <article className="overflow-hidden rounded-2xl bg-burgundy shadow-sm ring-1 ring-black/5">
      ...
      <div className="px-3"><LayflatPostPreview products={products} title={title} description={description} layout={layout} backgroundColor={backgroundColor} backgroundImage={backgroundImage} editorialDesign={editorialDesign} media={media} layflatStyle={layflatStyle} gridItemCount={gridItemCount} /></div>
