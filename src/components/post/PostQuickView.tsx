      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            className="relative flex max-h-[92dvh] min-h-0 w-full touch-pan-y flex-col overscroll-contain overflow-y-auto rounded-t-3xl bg-bg md:max-h-[calc(100dvh-2rem)] md:max-w-4xl md:flex-row md:overflow-hidden md:rounded-3xl"
          >
            <button
              type="button"
              onClick={onClose}
